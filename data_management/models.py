...
class GlassDeposition(models.Model):
    ...
    GlassDeposition_cleaning_step           = models.CharField(max_length=400, blank=False, default="Acetone + IPA", verbose_name="Cleaning step *")
    ...
    GlassDeposition_prebake_temp            = models.IntegerField(blank=False, default="100", verbose_name="Prebake temp (°C) *")
    GlassDeposition_prebake_duration        = models.PositiveIntegerField(blank=False, default="20", verbose_name="Prebake time (sec) *")
    GlassDeposition_amount_drops            = models.PositiveIntegerField(blank=False, default="3", verbose_name="Number of drops *")
    GlassDeposition_spin_rpm                = models.PositiveIntegerField(blank=False, default="4000", verbose_name="Spin speed (rpm) *")
    GlassDeposition_spin_duration           = models.PositiveIntegerField(blank=False, default="20", verbose_name="Spin time (sec) *")
    GlassDeposition_bake_temp               = models.IntegerField(blank=False, null=True, verbose_name="Bake temp (°C) *")
    GlassDeposition_bake_duration           = models.PositiveIntegerField(blank=False, null=True, verbose_name="Bake time (sec) *")
