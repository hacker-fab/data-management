...
class GlassDeposition(models.Model):
    ...
    GlassDeposition_prebake_duration            = models.PositiveIntegerField(blank=True, default="20", verbose_name="Prebake duration (sec) *")
    ...
    GlassDeposition_spin_duration               = models.PositiveIntegerField(blank=True, default="20", verbose_name="Spin duration (sec) *")
...
class Diffusion(models.Model):
    ...
    Diffusion_duration                          = models.PositiveIntegerField(blank=True, default="1800", verbose_name="Diffusion duration (sec) *")
    picture                                 = models.FileField(blank=True)
    content_type                            = models.CharField(max_length=50, blank=True)
...
class Patterning(models.Model):
    ...
    Patterning_hdms_prebake_duration            = models.PositiveIntegerField(blank=True, default="60", verbose_name="HMDS prebake duration (sec) *")
    Patterning_hdms_spin_rpm                = models.PositiveIntegerField(blank=True, default="3000", verbose_name="HMDS spin speed (rpm) *")
    Patterning_hdms_spin_duration               = models.PositiveIntegerField(blank=True, default="20", verbose_name="HMDS spin duration (sec) *")
    ...
    Patterning_hdms_bake_duration               = models.PositiveIntegerField(blank=True, default="20", verbose_name="HMDS bake duration (sec) *")
    Patterning_photoresist_spin_rpm         = models.PositiveIntegerField(blank=True, default="4000", verbose_name="PR spin speed (rpm) *")
    Patterning_photoresist_spin_duration        = models.PositiveIntegerField(blank=True, default="30", verbose_name="PR spin duration (sec) *")
    ...
    Patterning_photoresist_bake_duration        = models.PositiveIntegerField(blank=True, default="90", verbose_name="PR bake duration (sec) *")
    Patterning_exposure_pattern             = models.FileField(blank=True, null=True, verbose_name="Exposure pattern *")
    Patterning_exposure_duration                = models.PositiveIntegerField(blank=True, default="8000", verbose_name="Exposure duration (ms) *")
    Patterning_develop_duration                 = models.PositiveIntegerField(blank=True, default="60", verbose_name="Develop duration (sec) *")
...
class PlasmaEtch(models.Model):
    ...
    PlasmaEtch_etch_duration                    = models.PositiveIntegerField(blank=True, default="100", verbose_name="Etch duration (sec) *")
