...
class AluminumEvaporation(models.Model):
    ...
    AluminumEvaporation_time                = models.PositiveIntegerField(blank=False, null=True, verbose_name="Evaporation time (sec) *")
...
class GlassDeposition_P504(models.Model):
    ...
    GlassDeposition_P504_prebake_time            = models.PositiveIntegerField(blank=False, default="20", verbose_name="Prebake time (sec) *")
...
class Patterning(models.Model):
    ...
    Patterning_hdms_prebake_time            = models.PositiveIntegerField(blank=False, default="60", verbose_name="HMDS prebake time (sec) *")
...
class PlasmaClean(models.Model):
    ...
    PlasmaClean_clean_time                  = models.PositiveIntegerField(blank=False, null=True, verbose_name="Clean time (sec) *")
